var app = (function () {
    ...
    function Kt(e, t) {
        ...
        return (
            ...
            t.authHeader &&
                (n += `  -H '${t.authHeader.name}: ${Wt(t.authHeader.value || '')}' \\\n`),
            (n += `  -X ${t.method} \\\n`),
            t.cookies &&
                t.cookies.length &&
                t.cookies.forEach((e) => {
    ...
    function Xt(e, t) {
        ...
        if (
            ...
            t.authHeader &&
                (r += `request["${t.authHeader.name}"] = ${JSON.stringify(t.authHeader.value)}\n`),
            t.body)
        ) {
            const e = Qt(t.body);
            e && (r += `request.body = ${e}\n`);
    ...
    function en(e, t) {
        ...
        return (
            ...
            t.authHeader &&
                (r += `  req.Header.Add("${t.authHeader.name}", ${JSON.stringify(t.authHeader.value)})\n`),
            (r +=
